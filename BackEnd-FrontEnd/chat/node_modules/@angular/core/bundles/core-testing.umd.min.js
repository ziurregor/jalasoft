...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var C=function(){function e(){var e=this;this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r})}return e.prototype.done=function(e){this._resolve(e)},e.prototype.fail=function(e,t){this._reject(e)},Object.defineProperty(e.prototype,"promise",{get:function(){return this._promise},enumerable:!0,configurable:!0}),e}(),E=function(){function e(){}return e.prototype.insertRootElement=function(e){},e}(),P=new t.InjectionToken("ComponentFixtureAutoDetect"),D=new t.InjectionToken("ComponentFixtureNoNgZone");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(r)});t.push(c)}),j(),Promise.all(t).then(function(){})}var S=new Map,F=new Set;function R(e){return F.has(e)}function j(){var e=S;return S=new Map,e}function A(e){return"string"==typeof e?e:e.text()}var k=0,I=function(){function e(){this._references=new Map}return e.prototype.overrideMetadata=function(e,r,n){var o={};if(r&&function i(e){var t=[];Object.keys(e).forEach(function(e){e.startsWith("_")||t.push(e)});for(var r=e;r=Object.getPrototypeOf(r);)Object.keys(r).forEach(function(e){var n=Object.getOwnPropertyDescriptor(r,e);!e.startsWith("_")&&n&&"get"in n&&t.push(e)});return t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.ɵMetadataOverrider=I,e.async=function ge(e){var t="undefined"!=typeof Zone?Zone:null;if(!t)return function(){return Promise.reject("Zone is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/zone.js")};var r=t&&t[t.__symbol__("asyncTest")];return"function"==typeof r?r(e):function i(e){return n.jasmine?function(t){t||((t=function(){}).fail=function(e){throw e}),o(e,this,t,function(e){if("string"==typeof e)return t.fail(new Error(e));t.fail(e)})}:function(){var t=this;return new Promise(function(r,n){o(e,t,r,n)})}}(e)},e.ComponentFixture=i,e.resetFakeAsyncZone=m,e.fakeAsync=function _e(e){return v?v.fakeAsync(e):function t(e){return function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];var n=c.assertPresent();if(p)throw new Error("fakeAsync() calls can not be nested");p=!0;try{if(!l){if(n.getDelegate()instanceof u)throw new Error("fakeAsync() calls can not be nested");l=new u}var o=void 0,i=n.getDelegate();n.setDelegate(l);try{o=e.apply(this,t),h()}finally{n.setDelegate(i)}if(l.pendingPeriodicTimers.length>0)throw new Error(l.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(l.pendingTimers.length>0)throw new Error(l.pendingTimers.length+" timer(s) still in the queue.");return o}finally{p=!1,a()}}}(e)},e.tick=function Me(e){return void 0===e&&(e=0),v?v.tick(e):function t(e){void 0===e&&(e=0),d().tick(e)}(e)},e.flush=function be(e){return v?v.flush(e):function t(e){return d().flush(e)}(e)},e.discardPeriodicTasks=function Te(){if(v)return v.discardPeriodicTasks();!function e(){d().pendingPeriodicTimers.length=0}()},e.flushMicrotasks=function Oe(){return v?v.flushMicrotasks():h()},e.TestComponentRenderer=E,e.ComponentFixtureAutoDetect=P,e.ComponentFixtureNoNgZone=D,e.__core_private_testing_placeholder__="",e.ɵTestingCompiler=se,e.ɵTestingCompilerFactory=ue,Object.defineProperty(e,"__esModule",{value:!0})});